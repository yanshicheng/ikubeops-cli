...
# 需要手动修改
appNmae="github.com/yanshicheng/ikubeops-cli"
...
# 完整的项目名字
oldProjectFullNmae="github.com/yanshicheng/ikubeops-cli"
oldProjectName="ikubeops-cli"
...
change_project() {
  ...
  find "$baseDir/controller/" -type f -exec sed -i  "s@$oldProjectFullNmae@$appNmae@g" {} \;
